...
class DD_Elementor {
   ...
   public function register_frontend_scripts() {
		wp_enqueue_script( 'dd-frontend', DD_PLUGIN_DIR_URL . 'inc/modules/elementor/assets/dd-frontend.js', array( 'jquery' ), DD_PLUGIN_VERSION, true );
   ...
   public function register_frontend_styles() {
      wp_enqueue_style( 'dd-frontend', DD_PLUGIN_DIR_URL . 'inc/modules/elementor/assets/dd-frontend.css', array(), DD_PLUGIN_VERSION ); 
