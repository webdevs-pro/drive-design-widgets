	...
	protected function render() {
		...
		foreach($uls as $ul){
			...
			if ($settings['dd_taxonomy_unfold'] == 'all') {
				$toggleSpan->appendXML('<span class="sub-toggler opened"><i class="' . $settings['dd_menu_tree_icon'] . '"></i></span>');
			} else {
				$toggleSpan->appendXML('<span class="sub-toggler"><i class="' . $settings['dd_menu_tree_icon'] . '"></i></span>');
			}
